...
call function with 3 functions
numbers = (40,80,30)
print(4)
...
# you can use the variable below to enter you answer. 
answer9='to run or execute the set of actions'
...
output : ['ice cream','ground beef','oranges']
