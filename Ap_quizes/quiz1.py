...
A variable is a value that can be changed depending on the conditions.
# 2. Name three (3) operators we've learned about in class and describe 
# a situation where you would use each one. 
Addition:adds two values together, Subtraction:subtracts the second value from the first, Multiplication:multiplies two values together
