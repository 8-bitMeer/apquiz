...
# II. You may use notes in your repository
...
# Anyone caught using  these applications will automatically fail the quiz.
...
A computer program is a procedure that is useful for solving specific problems in a computer.

# 2. Describe what complexity and abstraction are, then provide an example
# of complexity in the real world and how we apply abstraction to that thing (your example must be original and cannot be an example
# used in our lecture slides ie car, grocery store, etc.). 
 
Complexity: a complexity is a state or quality of being intricate or complicated. 
Abstraction: the quality of dealing with ideas rather than events.

  # 3. What is Syntax in Python and why is it important to write proper syntax?

  Syntax is a tool that refers to the formation of the sentences and the grammatical rules.
...
# 6. What will be the output of the print functions when this code is ran, explain why
name = 'Bill'
student = name
name = 'Walter'
student= 'Richard'
...
int, float, And advanced python types.
...
# 10. Create three (3) separate functions that will do addition, subtraction, and multiplication respectively. 
...
# 13. When you run your code and see a type error in your terminal, what does that typically mean and how would you try to solve
# the issue?
...
# 15. Create a while loop that checks a user's password. If they enter the password correctly, they will get a message saying 
# that the password was entered successfully. If they enter the password incorrectly, it will tell the user to try again. 
# The user should only have three (3) attempts to get the password correct. If they enter the password incorrectly on the fourth 
...
# should return a message congratulating the user by name, and telling them what their new salary is with the 15%
